...
```bash
# 1. Fork on GitHub
# Visit: https://github.com/colinsenner/ProxmoxVED → Fork (top right)
...
git remote add upstream https://github.com/colinsenner/ProxmoxVED.git
...
- **GitHub**: https://github.com/colinsenner/ProxmoxVED
- **Issues**: https://github.com/colinsenner/ProxmoxVED/issues
- **Discussions**: https://github.com/colinsenner/ProxmoxVED/discussions
