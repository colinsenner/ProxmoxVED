...
# upstream   https://github.com/colinsenner/ProxmoxVED.git (fetch)
# upstream   https://github.com/colinsenner/ProxmoxVED.git (push)
```
...
print_info "Upstream: https://github.com/colinsenner/ProxmoxVED"
echo ""
